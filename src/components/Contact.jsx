...
export default function Contact() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    setStatus('Terima kasih! Pesan Anda telah diterima.');
      ...
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-gray-600">
            Undang untuk khutbah, minta bimbingan, atau kirimkan pesan.
          </p>
        </div>
        ...
        <div className="mx-auto mt-10 grid max-w-4xl gap-8 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 flex items-center gap-3 text-gray-700">
              ...
              <span>Seluruh dunia | Berbasis di Dubai, UEA</span>
            </div>

            <div className="mt-6 rounded-xl bg-emerald-50 p-4 text-sm text-emerald-900">
              Untuk pemesanan acara, cantumkan tanggal, lokasi, dan perkiraan jumlah audiens.
            </div>
          </div>
        </div>
      </div>
